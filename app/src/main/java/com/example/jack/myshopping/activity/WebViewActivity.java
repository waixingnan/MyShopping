...
public class WebViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != intent) {
            if(TextUtils.isEmpty(Url= getIntent().getStringExtra("url"))){
                Url="http://www.pclady.com.cn/?ocid=MSNCNLG13-6";
            }

            Logger.i(TAG, "onCreate: ------->>>>"+Url);
        }

//        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
//        TextView TitleTv = findViewById(R.id.toolbar_title_tv);
//        TitleTv.setText("内容详情");
//        ImageButton imageButton=findViewById(R.id.toolbar_left_ib);
//        imageButton.setImageResource(R.drawable.ic_backup_arrow_left_white_24dp);
//
//        Toolbar toolbar = findViewById(R.id.toolbar);
//        ToolbarUtil.getInstance().initToolBar(this, toolbar, R.drawable.ic_backup_arrow_left_white_24dp, "商品详情",
//                null, getResources().getColor(R.color.white), R.color.colorPrimary);
//
//        ImageButton LeftIb = findViewById(R.id.toolbar_left_ib);
